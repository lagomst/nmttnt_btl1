...
def main():
    ...
    population_size=3500 # Total population size in each generations
    best_selection_rate=0.02 # Percentage of population that has highest fit score to become parents of next generation
    random_selection_rate=0.012 # Percentage of population that is randomly picked to become parents
    max_nb_generations=500 # Max total ammount of generations allowed to run
    mutation_rate=0.045 # Chance of an individual mutating
    
    # Number of consecutive generation that do not improve before restarting
    restart_after_n_generations_without_improvement= max_nb_generations // 3 
